...
const Settings = () => {
  ...
  return (
    <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl text-base">
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-full bg-primary flex items-center justify-center text-primary-content font-bold text-base">
                      J
                    </div>
                    <div>
                ...
                <div className="p-4 border-t border-base-300 bg-base-100">
                  <div className="flex gap-2">
                    <input
                      type="text"
                      className="input input-bordered flex-1 text-base h-10 bg-base-100 text-base-content"
